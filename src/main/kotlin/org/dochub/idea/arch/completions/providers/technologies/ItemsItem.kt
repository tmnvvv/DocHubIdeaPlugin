...
class ItemsItem : FilteredCustomProvider() {

    override val rootPattern: ElementPattern<out PsiElement> = ItemsItem.rootPattern
    ...
    companion object {
        ...
        private val COMPLETION_KEYS = listOf(CompletionKey("title"))
